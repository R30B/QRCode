...
class QrCode:
    ...
    #polynomial division accoriding to galios field
...
""" 
    ...
    QR Code convention : 0 is white and 1 is black
"""
...
class QrBuilder():
    ...
    # for building finding pattern in qr code
    ...
    #position on which finding pattern is to be build
    ...
    #This builds the alignment pattern
    ...
    # position on which alignment pattern is to be build
    ...
    #position of timing pattern in a matrix
    ...
    # position of version pattern in QR version > 7
    ...
    #giving score to each mask for choosing the best one.
    ...
    #filling all the required patterns in the matrix
    ...
    def build_image(self, mask_number=None):
        ...
        image = ImageOps.scale(image, factor=10, resample=Image.Resampling.BOX)
        return image
